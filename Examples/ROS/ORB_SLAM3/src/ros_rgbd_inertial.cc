...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_img_rgb = n.subscribe("/camera/left/image_raw", 100, &ImageGrabber::GrabImageRgb,&igb);
    ros::Subscriber sub_img_depth = n.subscribe("/camera/depth_registered/image_raw", 100, &ImageGrabber::GrabImageDepth,&igb);
